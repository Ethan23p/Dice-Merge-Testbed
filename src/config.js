...
const DiceMergeConfig = (() => {
  ...
  const SCHEMA = [
    ...
    { id: 'pulseBurstDurationMs', group: 'Merge Impact', label: 'Extra pulse duration (merges over 3 dice)', unit: 'ms', initial: 70, min: 0, max: 2000, step: 5, apply: { type: 'css', varName: '--cfg-pulse-burst-duration', unit: 'ms' } },
